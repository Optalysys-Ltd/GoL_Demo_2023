**This is a work in progress fork of [OpenFHE](https://github.com/openfheorg/openfhe-development), used to test different approaches to integrating the Optalysys technology.**
